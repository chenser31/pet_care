...
function Carousel() {
  ...
  return (
    <div
      className="relative aspect-[16/10] min-h-[320px] w-full overflow-hidden rounded-[18px] bg-[#eef8f2] shadow-soft sm:min-h-[420px] lg:min-h-[520px]"
      role="region"
    ...
    >
      {carouselImages.map((image, index) => (
        <div
          key={image}
          className={`absolute inset-0 bg-contain bg-center bg-no-repeat transition duration-700 ${
    ...
    <>
      ...
      <main id="top">
        ...
        <section id="contact" className="bg-[linear-gradient(135deg,rgba(207,231,220,0.72),rgba(255,244,216,0.8)),#f5f0e8] py-16 sm:py-20" aria-labelledby="contact-title">
          <div className="mx-auto grid w-[min(1120px,calc(100%-32px))] grid-cols-1 gap-7">
